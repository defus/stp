  ...
  <header id="home">
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(images/slider/transport-routier.jpg)">
          <div class="caption">
        ...
        <div class="item" style="background-image: url(images/slider/camions.jpg)">
          <div class="caption">
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="single-table wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
              ...
              <a href="#" class="btn btn-lg btn-primary">Inscrivez-vous</a>
            </div>
          </div>
          <div class="col-sm-4">
